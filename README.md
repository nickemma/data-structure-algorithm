# Crack DSA+ — The Animated Aura Series

An interview-preparation workspace for mastering **patterns**, not memorising answers.

It contains two tracks:

- [DSA: Blind 75](dsa/README.md) — recognise a pattern, attempt problems yourself, then study and implement the solution in Java, Python, and TypeScript.
- [System Design](system-design/README.md) — learn how to scope systems, articulate trade-offs, and practise realistic design interviews.
